...
pacman -Qenq > "$DOTFILES/packages/pacman.txt"
pacman -Qemq > "$DOTFILES/packages/aur.txt"
...
echo "  sudo cp system/99-gpu-dev-paths.rules /etc/udev/rules.d/  # adjust PCI slots for new hardware"
